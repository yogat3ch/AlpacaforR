...
vcr::use_cassette("market_data works when v = 2 and full = T", {
...
vcr::use_cassette("market_data errors are informative when incompatible arguments are requested", {
...
vcr::use_cassette("market_data warning and messages are informative when incompatible arguments are requested and arguments are omitted.", {
